...
setup(
    ...
    test_suite = 'tests',
    dependency_links=['https://github.com/trezor/python-mnemonic/archive/master.zip#egg=mnemonic-0.5'],
    install_requires=['ecdsa>=0.9', 'RPi.GPIO', 'spidev', 'pyserial', 'protobuf', 'mnemonic>=0.5'],
