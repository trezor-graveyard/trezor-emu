...
_MESSAGETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_DebugLinkDecision', index=36, number=100,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), '\240\265\030\001'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_DebugLinkGetState', index=37, number=101,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), '\240\265\030\001'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_DebugLinkState', index=38, number=102,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), '\250\265\030\001'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MessageType_DebugLinkStop', index=39, number=103,
      options=_descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), '\240\265\030\001'),
      type=None),
  ],
